...
- **풀페이지 스크롤 구현**: 섹션 간 부드러운 전환을 위한 풀페이지 스크롤 기법을 습득했습니다.
- **인터랙티브 애니메이션**: requestAnimationFrame을 활용한 성능 최적화된 애니메이션 구현 방법을 배웠습니다.
- **SCSS 활용**: 중첩 선택자와 변수를 활용한 효율적인 스타일 관리 방법을 익혔습니다.
- **이벤트 위임**: 다수의 요소에 대한 이벤트 처리를 최적화하는 방법을 학습했습니다.

### 디자인 측면

- **게임 테마 디자인**: 게임의 시각적 아이덴티티를 웹 디자인에 적용하는 방법을 연구했습니다.
- **시각적 계층 구조**: 사용자의 시선을 효과적으로 유도하는 시각적 계층 구조 설계 방법을 배웠습니다.
- **애니메이션 타이밍**: 사용자 경험을 향상시키는 적절한 애니메이션 타이밍과 이징 함수 활용법을 익혔습니다.
